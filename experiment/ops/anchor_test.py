...
class AnchorTest(parameterized.TestCase, tf.test.TestCase):
  ...
  def testAnchorRpnSample(
      self, num_anchors, num_positives,
  ...
  def testAnchorGeneration(
      self, min_level, max_level, num_scales,
  ...
  def testLabelAnchors(
      self, min_level, max_level, num_scales, aspect_ratios,
  ...
  def testEquivalentResult(
      self, min_level, max_level, aspect_ratios,
    ...
    expected_anchors = expected_anchor_gen.multi_level_boxes
