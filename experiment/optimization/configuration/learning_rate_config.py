...
class ConstantLrConfig(base_config.Config):
  ...
  ----------
  name : str
    The name of the learning rate schedule. Defaults to Constant.
  learning_rate : float
    a float of learning rate. Defaults to 0.1.
  """
  name: str = 'Constant'
...
class StepwiseLrConfig(base_config.Config):
  ...
  :var name: The name of the learning rate schedule. Defaults to PiecewiseConstant.
  :var boundaries: A list of ints of strictly increasing entries. Defaults to None.
  :var values: A list of floats that specifies the values for the intervals defined
  ...
  :var offset: An int. The offset applied to steps. Defaults to 0.
  """
...
class ExponentialLrConfig(base_config.Config):
  ...
  This class is a containers for the exponential learning rate decay configuration.

  :var name: The name of the learning rate schedule. Defaults to ExponentialDecay.
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var decay_steps: A positive integer that is used for decay computation. Defaults
      to None.
  :var decay_rate: A float. Defaults to None.
  :var staircase: A boolean, if true, learning rate is decreased at discreate
...
class PolynomialLrConfig(base_config.Config):
  ...
  This class is a containers for the polynomial learning rate decay configuration.

  :var name: The name of the learning rate schedule. Defaults to PolynomialDecay.
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var decay_steps: A positive integer that is used for decay computation. Defaults
      to None.
  :var end_learning_rate: A float.  The minimal end learning rate.
  :var power: A float.  The power of the polynomial. Defaults to linear, 1.0.
  :var cycle: A boolean, whether or not it should cycle beyond decay_steps.
      Defaults to False.
  :var offset: An int. The offset applied to steps. Defaults to 0.
  """
...
class CosineLrConfig(base_config.Config):
  ...
  :var name: The name of the learning rate schedule. Defaults to CosineDecay.
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var decay_steps: A positive integer that is used for decay computation. Defaults
      to None.
  :var alpha: A float.  Minimum learning rate value as a fraction of
...
class DirectPowerLrConfig(base_config.Config):
  ...
  :var name: The name of the learning rate schedule. Defaults to DirectPowerDecay.
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var power: A float. Defaults to -0.5, for sqrt decay.
  """
...
class PowerAndLinearDecayLrConfig(base_config.Config):
  ...
  :var name: The name of the learning rate schedule. Defaults to
      PowerAndLinearDecay.
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var total_decay_steps: An int. The total number of steps for power + linear
      decay. Defaults to None.
  :var power: A float. The order of the polynomial. Defaults to -0.5, for sqrt
      decay.
  :var linear_decay_fraction: A float. In the last `linear_decay_fraction` steps,
...
class PowerDecayWithOffsetLrConfig(base_config.Config):
  ...
  :var initial_learning_rate: A float. The initial learning rate. Defaults to None.
  :var power: A float. Defaults to -0.5, for sqrt decay.
  :var offset: An integer. Power decay happens after `offset` steps.
  :var pre_offset_learning_rate: A float. The constant learning rate before
      `offset` steps.
  """
...
class StepCosineLrConfig(base_config.Config):
  ...
  configuration. It will configure an instance of StepCosineDecayWithOffset keras
  learning rate schedule.
...
class LinearWarmupConfig(base_config.Config):
  ...
  :var name: The name of warmup schedule. Defaults to linear.
  :var warmup_learning_rate: Initial learning rate for the warmup. Defaults to 0.
  :var warmup_steps: Warmup steps. Defaults to None.
  """
  name: str = 'linear'
...
class PolynomialWarmupConfig(base_config.Config):
  ...
  :var name: The name of warmup schedule. Defaults to Polynomial.
  :var power: Polynomial power. Defaults to 1.
  :var warmup_steps: Warmup steps. Defaults to None.
  """
  name: str = 'polynomial'
  power: float = 1
