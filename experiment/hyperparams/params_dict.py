...
class ParamsDict(object):
  ...
  def __init__(self, default_params=None, restrictions=None):
    ...
    :param default_params: a Python dict or another ParamsDict object including
        the default parameters to initialize.
    :param restrictions: a list of strings, which define a list of restrictions
  ...
  def __setattr__(self, k, v):
    ...
    :param v: the value to be used to set the key `k`.
    :raise KeyError: if k is not defined in the ParamsDict.
    :raise ValueError: if ParamsDict is locked, no change is allowed.
    """
  ...
  def __getattr__(self, k):
    """Gets the value of existing key.

    :param k: the key string.
    :return: the value of the key.
    :raise AttributeError: if k is not defined in the ParamsDict.
    """
    if k not in self.__dict__.keys():
  ...
  def __contains__(self, k):
    ...
    :param k: the key string.
    :return: whether the key exists in the ParamsDict.
    """
  ...
  def get(self, k, v=None):
    ...
    :param k: the key string.
    :param v: the default value if the `k` is not in ParamsDict.
    :return: the value of the given `k`.
    """
  ...
  def __delattr__(self, k):
    ...
    :param k: the key string to be deleted.
    :raise AttributeError: if `k` is reserved or not defined in the ParamsDict.
    :raise ValueError: if the ParamsDict instance has been locked.
    """
  ...
  def override(self, override_params, is_strict=True):
    ...
    :param override_params: a dict or a ParamsDict specifying the parameters to
        be overridden.
    :param is_strict: a boolean specifying whether override is strict or not. If
    ...
    :raise ValueError: if the ParamsDict has been locked.
    """
    if self._locked:
      raise ValueError('The ParamsDict has been locked. No change is allowed.')
  ...
  def as_dict(self):
    ...
    :return: The dict representation of this ParamsDict.
    """
    params_dict = {}
  ...
  def validate(self):
    ...
    underlying Python implementation. Users should make sure the define
    ...
    :raise ValueError: if the restriction defined in the string is not
        supported.
    """
...
def nested_csv_str_to_json_str(csv_str):
  ...
  :param csv_str: the comma separated string.
  :return: the converted JSON string.
  :raise ValueError: If csv_str is not in a comma separated string or
...
def override_params_dict(params, dict_or_string_or_yaml_file, is_strict):
  ...
  :param params: a ParamsDict object to be overridden.
  :param dict_or_string_or_yaml_file: a Python dict, JSON/YAML/CSV string or
      path to a YAML file specifying the parameters to be overridden.
  :param is_strict: a boolean specifying whether override is strict or not.
  :return: the overridden ParamsDict object.
  :raise ValueError: if failed to override the parameters.
  """
