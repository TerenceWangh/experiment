...
def run_experiment(
  ...
  """Runs train/eval configured by the experiment params.
    ...
    :param distribution_strategy: A distribution distribution_strategy.
    :param task: A Task instance.
    :param mode: A 'str', specifying the mode. Can be 'train', 'eval', 'train_and_eval'
      or 'continuous_eval'.
    :param params: ExperimentConfig instance.
    :param model_dir: A 'str', a path to store model checkpoints and summaries.
    :param run_post_eval: Whether to run post eval once after training, metrics logs
      are returned.
    :param save_summary: Whether to save train and validation summary.
    :param trainer: the base_trainer.Trainer instance. It should be created within the
      strategy.scope().
    :param controller_cls: The controller class to manage the train and eval process.
      Must be a orbit.Controller subclass.

    :return A 2-tuple of (model, eval_logs).
      model: `tf.keras.Model` instance.
      eval_logs: return eval metrics logs when run_post_eval is set to true,
        otherwise, returns {}.
  """
