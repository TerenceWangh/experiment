...
from experiment.orbit import standard_runner
  ...
  def test_early_stop_on_eval_loss(self):
    ...
    class EarlyStopController(controller.Controller):
      ...
      def train_and_evaluate(self,
        ...
        while self._global_step.numpy() < train_steps:
          interval = min(train_steps - self._global_step.numpy(), eval_interval)
          num_steps = self._global_step.numpy() + interval
