...
def define_flags():
  ...
  ```
  from absl import flags
  from official.common import flags as tfm_flags  # pylint:
  ...
  flags.DEFINE_multi_string(
      ...
      help='YAML/JSON files which specifies overrides. The override order '
           'follows the order of args. Note that each file can be used as an '
           'override template to override the default parameters specified in '
           'Python. If the same parameter is specified in both `--config_file` '
           'and `--params_override`, `config_file` will be used first, '
           'followed '
           'by params_override.')
  ...
  flags.DEFINE_string(
      ...
      help='a YAML/JSON string or a YAML file which specifies additional '
           ...
           '`train_batch_size`. The final override order of parameters: '
           'default_model_params --> params from config_file --> params in '
           'params_override. See also the help message of `--config_file`.')
  ...
  flags.DEFINE_string(
      ...
      help='The Cloud TPU to use for training. This should be either the name '
           ...
           'grpc://ip.address.of.tpu:8470 '
           'url.')

  flags.DEFINE_string(
      'tf_data_service', default=None, help='The tf.data serveice address')
